...
project = 'molecool'
copyright = ("2020, Angela Harper. Project structure based on the "
...
texinfo_documents = [
    (master_doc, 'molecool', 'molecool Documentation',
     author, 'molecool', 'A Python package for analyzing and visualizing xyz files. For MolSSI Workshop Python Packag development workshop.',
     'Miscellaneous'),
]
